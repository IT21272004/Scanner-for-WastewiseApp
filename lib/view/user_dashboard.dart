...
// import 'package:wastewise/view/shedule.dart';
import 'package:wastewise/view/sorting_guidance.dart';
              ...
              child: GridView.count(
                ...
                children: [
                  buildGridItem('Shedule a pickup', Icons.access_alarm, () {
                    ...
                    //     context,
                    //     MaterialPageRoute(
                    //         builder: (context) => const sheduleScreen(text: '',)),
                    //   );
                  }),
                  ...
                  buildGridItem('Sorting guidance', Icons.account_circle, () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const SortingGuidanceScreen()),
                    );
                  }),
                ],
              ),
